...
- **network:** {'net_profile': 'Cellular', 'tc_dev': None, 'tc_delay': None, 'tc_rate': None, 'tc_loss': None}

## Latency (seconds, end-to-end)

| arm | median | p95 |
|---|---:|---:|
| baseline (inline json) | 0.098738 | 0.715329 |
| client (materialize+describe+fetch) | 0.294577 | 0.746412 |
| server_auto (call+fetch) | 0.108147 | 0.603001 |
...
- baseline/client latency: 0.3363
- baseline/server_auto latency: 0.932328
