...
| arm | median | p95 |
|---|---:|---:|
| baseline (inline json) | 0.013272 | 0.187685 |
| client (materialize+describe+fetch) | 0.039181 | 0.178717 |
| server_auto (call+fetch) | 0.020253 | 0.1478 |
...
- baseline/client latency: 0.370281
- baseline/server_auto latency: 0.750494
...
| arm | median | p95 |
|---|---:|---:|
| client | 0.02279 | 0.073151 |
| server_auto | 0.01775 | 0.031133 |
