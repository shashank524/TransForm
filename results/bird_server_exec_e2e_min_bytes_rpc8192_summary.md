...
| arm | median | p95 |
|---|---:|---:|
| baseline (inline json) | 0.012355 | 0.200107 |
| client (materialize+describe+fetch) | 0.03687 | 0.189951 |
| server_auto (call+fetch) | 0.017818 | 0.152384 |
...
- baseline/client latency: 0.35411
- baseline/server_auto latency: 0.749443
