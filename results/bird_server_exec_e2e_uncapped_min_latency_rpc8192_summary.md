...
| arm | median | p95 |
|---|---:|---:|
| baseline (inline json) | 0.008614 | 0.144714 |
| client (materialize+describe+fetch) | 0.02667 | 0.133947 |
| server_auto (call+fetch) | 0.012203 | 0.109683 |
...
- baseline/client latency: 0.379856
- baseline/server_auto latency: 0.780803
