...
| arm | median | p95 |
|---|---:|---:|
| baseline (inline json) | 0.014967 | 0.228534 |
| client (materialize+describe+fetch) | 0.044445 | 0.216605 |
| server_auto (call+fetch) | 0.02077 | 0.168267 |
...
- baseline/client latency: 0.376999
- baseline/server_auto latency: 0.772954
...
| arm | median | p95 |
|---|---:|---:|
| client | 0.01687 | 0.065044 |
| server_auto | 0.017075 | 0.031499 |
