...
- **Format select target:** min_bytes
...
|---|---:|---:|
| NL2SQL | — | — |
| Baseline fetch (JSON only) | 0.005386 | 0.025533 |
| Describe (enhanced) | 0.004517 | — |
| Enhanced fetch (chosen format) | 0.005146 | 0.01563 |
| Enhanced describe + fetch | 0.009735 | — |
...
| baseline_fetch_s / enhanced_fetch_s | 1.071508 |
