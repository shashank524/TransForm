...
|---|---:|---:|
| NL2SQL | — | — |
| Baseline fetch (JSON only) | 0.005611 | 0.053406 |
| Describe (enhanced) | 0.003694 | 0.024597 |
| Enhanced fetch (chosen format) | 0.005388 | 0.032608 |
| Enhanced describe + fetch | 0.009255 | 0.053907 |
...
- **Sum of baseline bytes (all successful transport rows):** 43442263
- **Sum of enhanced bytes (same):** 6420178

## Ratios (median)

| baseline_fetch_s / enhanced_fetch_s | 1.063221 |
